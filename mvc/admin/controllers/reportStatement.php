...
class reportStatement extends Controllers
{
    ...
    //---------------------------------Page Accountant ketoan---
    public function reportView_AC()
    {
        $qrbill = $this->model("billModel");
        $this->view("masterAccountantLayout", [
            "pageaccountant" => "pageAccountant/report_Statement",
            "bill_all" => $qrbill->bill_all(),
            // "st_for_bill" => $qrbill->st_bill(),
            "st_for_bill_paid" => $qrbill->st_bill_paid(),
            "st_for_bill_unpaid" => $qrbill->st_bill_unpaid(),
    ...
    public function reportView_detail_AC($year)
    {
        $qrbill = $this->model("billModel");
        $this->view("masterAccountantLayout", [
            "pageaccountant" => "pageAccountant/report_Statement_detail",
            "bill_all" => $qrbill->bill_all(),
            // "st_for_bill" => $qrbill->st_bill(),
            "st_for_bill_paid" => $qrbill->st_bill_paid(),
            "st_for_bill_unpaid" => $qrbill->st_bill_unpaid(),
